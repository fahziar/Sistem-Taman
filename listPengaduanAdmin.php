...
<body class="metro" background-color="green">	
    ...
    <div class="navigation-bar-content container">
		...
		<a href="listPengaduanAdmin.html" class="element"><span class="icon-list"></span><b> Daftar Pengaduan</b></a>
	  ...
	  <div class="row">
		<div class="panel-content fg-dark nlp nrp">
			...
			<div class="bg-darkBlue" style="height: 200px">
				...
				<a href="javascript:hapusPengaduan(<?php echo $row['id'];?>);" class="fg-blue"><span class="icon-remove fg-white"></span> Hapus Pengaduan </a> |
				<div class="span2 input-control select info-state">
					<select>
