...
<div class="">
  <div style="background: url(images/bg.jpg); background-size: cover; height:620px ">
	<div class="span4 place-left bg-darkBlue padding20 text-center">
		<h1 class="fg-white"><br>Edit <br>Taman
		</h1>
  ...
  <div class="container" style="padding: 30px 10px">	
	  <div class="row">
		  <div class="offset5">
			<form method="post" action="editTaman2.php?id=<?php echo $_GET['id'];?>">
				...
				<br>
				<br>
				<button type="submit" class="bg-darkBlue fg-white large" id="kirimButton">Edit</button>
			</form>
		  </div>
	  </div>
	</div>
